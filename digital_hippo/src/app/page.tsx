...
const perks = [
  {
    ...
    description: "Get your assets to your email in seconds and download it right away."
  },
  {
  ...
  },
  {
    name: "For the planet",
    Icon: Leaf,
    description: "We've pledged 1% of sales to the preservation and restoration of the environment."
  },
]
